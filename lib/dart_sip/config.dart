...
class Settings {
  ...
  */
  ...
  @override
  String toString() {
    return 'Settings{authorization_user: $authorization_user, password: $password, realm: $realm, ha1: $ha1, domain: $domain, display_name: $display_name, uri: $uri, contact_uri: $contact_uri, user_agent: $user_agent, instance_id: $instance_id, use_preloaded_route: $use_preloaded_route, session_timers: $session_timers, session_timers_refresh_method: $session_timers_refresh_method, no_answer_timeout: $no_answer_timeout, register: $register, register_expires: $register_expires, registrar_server: $registrar_server, register_extra_contact_uri_params: $register_extra_contact_uri_params, dtmf_mode: $dtmf_mode, sockets: $sockets, connection_recovery_max_interval: $connection_recovery_max_interval, connection_recovery_min_interval: $connection_recovery_min_interval, via_host: $via_host, jssip_id: $jssip_id, hostport_params: $hostport_params, ice_gathering_timeout: $ice_gathering_timeout, sip_message_delay: $sip_message_delay}';
  }
}

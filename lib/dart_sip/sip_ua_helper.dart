...
import 'package:flutter_webrtc_mifone/dart_sip/map_helper.dart';
...
class SIPUAHelper extends EventManager {
  ...
  final Map<String?, Call> calls = <String?, Call>{};
  ...
  Future<void> start(UaSettings uaSettings) async {
    ...
    print('extra:: ${_settings.register_extra_contact_uri_params}');
    ...
    _settings.via_host = uaSettings.domain;
    try {
      _ua = UA(_settings);
    ...
    Map<String, dynamic> defaultOptions = <String, dynamic>{
      ...
      'rtcConstraints': <String, dynamic>{
        ...
        'optional': <Map<String, dynamic>>[
          <String, dynamic>{'DtlsSrtpKeyAgreement': true, 'ipv6': false},
        ],
      },
...
class Call {
  ...
  factory Call.fromJson(Map<String, dynamic> json) {
    return Call(json["_id"], json["_session"], json["state"]);
  }

  @override
  String toString() {
    return 'Call{_id: $_id, _session: $_session, state: $state}';
  }

  Map<String, dynamic> toJson() {
    return {"_id": _id, "_session": _session, "state": state};
  }
  ...
  void answer(Map<String, dynamic> options, {MediaStream? mediaStream = null}) {
    ...
    print("Session call state: " + _session.toString());
...
enum DtmfMode { INFO, RFC2833, RFC8599 }
